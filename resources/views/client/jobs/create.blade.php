    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                ...
                <p class="text-muted small mb-0">Define your requirements to attract the right freelancers.</p>
            </div>
                ...
                <form action="{{ route('client.jobs.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select">
                                ...
                                <option value="fixed_price" {{ old('type') == 'fixed_price' ? 'selected' : '' }}>{{ __('client.fixed_price') }}</option>
                                <option value="hourly" {{ old('type') == 'hourly' ? 'selected' : '' }}>{{ __('client.hourly') }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" id="skillSearch" class="form-control border-start-0 bg-light" placeholder="Search standard skills...">
                        </div>

                        {{-- Standard Skills List --}}
                        <div class="card bg-light border-0 p-3 mb-3">
                            <div class="row row-cols-2 row-cols-md-3 g-2" id="skillsContainer" style="max-height: 200px; overflow-y: auto;">
                                @foreach($skills as $skill)
                                    <div class="col skill-item" data-name="{{ strtolower($skill->name) }}">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label w-100" for="skill_{{ $skill->id }}">{{ $skill->name }}</label>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            <div id="noResults" class="text-center text-muted mt-2 d-none">
                                <small>No standard skill found.</small>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="e.g. Jenkins, Kubernetes, Legacy Systems">
                            <div class="form-text">If you don't see a skill above, type it here (comma separated).</div>
                        </div>
...
<style>
    #skillsContainer::-webkit-scrollbar { width: 6px; }
    #skillsContainer::-webkit-scrollbar-track { background: #e9ecef; }
    #skillsContainer::-webkit-scrollbar-thumb { background: #ced4da; border-radius: 4px; }
</style>
@endsection